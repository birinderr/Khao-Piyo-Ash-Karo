            ...
            <div className="grid grid-cols-1 sm:grid-cols-2">
              ...
              >
                <h1 className="text-5xl sm:text-5xl lg:text-7xl font-bold">
                  ...
                  <span class="bg-clip-text text-transparent bg-gradient-to-b from-primary to-secondary block">
                    Khao Piyo Ash Karo
                  </span>
                  <span className="block">Zone</span>
                </h1>
                <p className="text-lg text-gray-600 dark:text-gray-300 font-medium leading-relaxed">
                    Relish the flavors that bring joy to your table—crafted with love, just for you.
                </p>
                <div>
